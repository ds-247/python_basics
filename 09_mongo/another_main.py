...
video_collection = None  # Initialize as None

def connect():
    global video_collection
    try:
        client = MongoClient('mongodb+srv://<username>:<pass>@vidlycluster.rw7lwml.mongodb.net/', tlsAllowInvalidCertificates=True)
        db = client['pymongo']
